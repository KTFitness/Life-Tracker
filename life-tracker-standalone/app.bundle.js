(() => {
  ...
  function TodayTab({ today, viewDate, setViewDate, fitnessSettings, ziipSettings, todos, weightLogs, meals, weeklyPool, todayPicks, setTodayPicks, setTab }) {
  ...
  function MealsTab({ today, meals, setMeals, recipes, setRecipes, shoppingList, setShoppingList }) {
    ...
    const saveNewRecipe = () => {
      ...
      setRecipes([...recipes, { id: "recipe-" + Date.now(), name: newRecipeName, ingredients, instructions: newInstructions }]);
      setNewRecipeName("");
