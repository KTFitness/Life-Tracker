(() => {
  ...
  function App() {
    ...
    const [recurringPrefillText, setRecurringPrefillText] = useState("");
  ...
  function TodayTab({ today, viewDate, setViewDate, fitnessSettings, fitnessOverrides, fitnessLogs, ziipSettings, skinPlan, ledMaskDone, setLedMaskDone, todos, setTodos, meals, weeklyPool, todayPicks, setTodayPicks, poolDone, setPoolDone, dailyOrder, setDailyOrder, recurringTasks, recurringDone, setRecurringDone, dailyReflections, setDailyReflections, focusItems, setFocusItems, focusDone, setFocusDone, setRecurringPrefillText, setTab }) {
    ...
    const promoteToRecurring = (t) => {
      setRecurringPrefillText(t.text);
  ...
  function TodoTab({ todos, setTodos, weeklyPool, setWeeklyPool, todayPicks, setTodayPicks, dismissedIds, setDismissedIds, recurringTasks, setRecurringTasks, focusItems, setFocusItems, focusDone, recurringPrefillText, setRecurringPrefillText, today }) {
    ...
    const toggleSection = (key) => setCollapsedSections({ ...collapsedSections, [key]: !isCollapsed(key) });
    useEffect(() => {
      if (recurringPrefillText) {
        setNewRecurringText(recurringPrefillText);
        setCollapsedSections((cur) => ({ ...cur, recurring: false }));
        setRecurringPrefillText("");
      }
    }, [recurringPrefillText]);
