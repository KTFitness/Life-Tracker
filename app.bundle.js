(() => {
  ...
  function SkinTab({ today, isRetreatDay, ziipSettings, setZiipSettings, ziipToday, ziipDayIdx, ziipDone, setZiipDone, amDone, setAmDone, pmDone, setPmDone, skinPlan, setSkinPlan, ledMaskDone, setLedMaskDone }) {
    ...
    ), skinPlan[editDay][editPeriod].map((step) => /* @__PURE__ */ React.createElement("div", { key: step.id, style: { marginBottom: 14, paddingBottom: 12, borderBottom: `1px solid ${COLORS.line}` } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center", marginBottom: 6 } }, /* @__PURE__ */ React.createElement(
      Input,
      {
        value: step.label,
