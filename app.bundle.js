(() => {
  ...
  function TodoTab({ todos, setTodos, weeklyPool, setWeeklyPool, todayPicks, setTodayPicks, dismissedIds, setDismissedIds, recurringTasks, setRecurringTasks, focusItems, setFocusItems, today }) {
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "Short reminders of what you're trying to keep front of mind \u2014 shown at the top of Glance and Week. Not tracked or ticked off, just there to nudge you." }, "Focus"), focusItems.map((f, i) => /* @__PURE__ */ React.createElement("div", { key: f.id, style: { display: "flex", alignItems: "center", gap: 8, padding: "6px 0", borderBottom: `1px solid ${COLORS.line}` } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React.createElement("button", { onClick: () => moveFocusItem(f.id, -1), disabled: i === 0, style: { background: "none", border: "none", color: i === 0 ? COLORS.line : COLORS.inkSoft, cursor: i === 0 ? "default" : "pointer", fontSize: 11, lineHeight: 1, padding: "0 4px" } }, "\u25B2"), /* @__PURE__ */ React.createElement("button", { onClick: () => moveFocusItem(f.id, 1), disabled: i === focusItems.length - 1, style: { background: "none", border: "none", color: i === focusItems.length - 1 ? COLORS.line : COLORS.inkSoft, cursor: i === focusItems.length - 1 ? "default" : "pointer", fontSize: 11, lineHeight: 1, padding: "0 4px" } }, "\u25BC")), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, fontSize: 14, color: COLORS.ink } }, f.text), /* @__PURE__ */ React.createElement("button", { onClick: () => removeFocusItem(f.id), style: { background: "none", border: "none", color: COLORS.danger, cursor: "pointer", fontSize: 12 } }, "\u2715"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, marginTop: 10 } }, /* @__PURE__ */ React.createElement(Input, { placeholder: "e.g. Less screen time", value: newFocusText, onChange: (e) => setNewFocusText(e.target.value), onKeyDown: (e) => {
