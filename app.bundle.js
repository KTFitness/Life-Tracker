(() => {
  ...
  function TodoTab({ todos, setTodos, weeklyPool, setWeeklyPool, todayPicks, setTodayPicks, dismissedIds, setDismissedIds, recurringTasks, setRecurringTasks, focusItems, setFocusItems, focusDone, today }) {
    ...
    const CollapseHeader = ({ sectionKey, children }) => /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: COLORS.inkSoft, transform: isCollapsed(sectionKey) ? "rotate(-90deg)" : "none", display: "inline-block", transition: "transform 0.15s" } }, "\u25BE"),
      children
    );
