...
Notes: ${notes || "(none)"}`;
  ...
  function MealsTab({ today, meals, setMeals, recipes, setRecipes, shoppingList, setShoppingList, nutritionTargets, setNutritionTargets }) {
    ...
    const saveNewRecipe = () => {
      ...
      if (newFiber) recipe.fiber = parseFloat(newFiber);
      if (newCalcium) recipe.calcium = parseFloat(newCalcium);
    ...
    const saveEditRecipe = () => {
      ...
      setRecipes(recipes.map((r) => r.id === editRecipeId ? {
        ...
        fiber: editFiber ? parseFloat(editFiber) : void 0,
        calcium: editCalcium ? parseFloat(editCalcium) : void 0
      } : r));
    ...
    const parsePastedRecipe = () => {
      ...
      if (macros.calories !== void 0) recipe.calories = macros.calories;
      if (macros.protein !== void 0) recipe.protein = macros.protein;
      if (macros.carbs !== void 0) recipe.carbs = macros.carbs;
      if (macros.fat !== void 0) recipe.fat = macros.fat;
      if (macros.fiber !== void 0) recipe.fiber = macros.fiber;
      if (macros.calcium !== void 0) recipe.calcium = macros.calcium;
      setRecipes([...recipes, recipe]);
      setPasteText("");
    };
    ...
    const addQuickLog = () => {
      ...
      const item = {
        ...
        calories: parseFloat(quickLogCalories) || 0,
        protein: parseFloat(quickLogProtein) || 0,
        carbs: parseFloat(quickLogCarbs) || 0,
        fat: parseFloat(quickLogFat) || 0,
        fiber: parseFloat(quickLogFiber) || 0,
        calcium: parseFloat(quickLogCalcium) || 0
      };
