...
Notes: ${notes || "(none)"}`;
  ...
  var BLOCKS = [
    ...
    },
    {
      ...
      days: [
        ...
        // repeated identically every week of this block — a maintenance run at Week 9 intensity, not progressive
        "Cycling \u2014 ROUVY structured/interval session",
        "Iron \u2014 Full Body maintenance (40 min)",
        "__PILATES_ROTATION__"
      ]
  ...
  function computeFitnessForDate(dateStr, fitnessSettings, fitnessOverrides) {
    ...
    if (scheduledSession === "__PILATES_ROTATION__") {
      ...
      const block2StartDate = addDaysISO(fitnessSettings.startDate, BLOCK_WEEKS[0] * 7);
      scheduledSession = computeC25KSession(dateStr, block2StartDate);
