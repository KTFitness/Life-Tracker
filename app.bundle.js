...
Notes: ${notes || "(none)"}`;
  ...
  function ScheduleSection({ viewDate, timeScheduleSettings, setTimeScheduleSettings, morningTemplate, setMorningTemplate, eveningTemplate, setEveningTemplate, timeSchedules, setTimeSchedules }) {
