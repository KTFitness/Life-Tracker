(() => {
  ...
  function TodayTab({ today, viewDate, setViewDate, fitnessSettings, fitnessOverrides, ziipSettings, todos, setTodos, weightLogs, meals, weeklyPool, todayPicks, setTodayPicks, poolDone, setPoolDone, dailyOrder, setDailyOrder, setTab }) {
  ...
  function WeekTab({ today, fitnessSettings, fitnessOverrides, ziipSettings, todos, meals, setTab, setViewDate }) {
  ...
  function FitnessTab({ settings, setSettings, fitnessOverrides, setFitnessOverrides, logs, setLogs, ironLogs, setIronLogs, ironEquipment, setIronEquipment, today, isRetreatDay, regularSession, block, blockIdx, weekNum, dayInBlock }) {
  ...
  function TodoTab({ todos, setTodos, weeklyPool, setWeeklyPool, todayPicks, setTodayPicks, dismissedIds, setDismissedIds, today }) {
    ...
    }), weeklyPool.filter((p) => categoryOf(p) === "other").length > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, fontWeight: 700, color: COLORS.inkSoft, marginTop: 14, marginBottom: 2 } }, "Uncategorised"), renderPoolGroup(weeklyPool.filter((p) => categoryOf(p) === "other")))), /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(SectionTitle, null, "Add a dated to-do"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement(Input, { type: "date", value: date, onChange: (e) => setDate(e.target.value) }), /* @__PURE__ */ React.createElement(Input, { placeholder: "What needs doing", value: text, onChange: (e) => setText(e.target.value), style: { flex: 1, minWidth: 140 } }), /* @__PURE__ */ React.createElement(Btn, { onClick: add }, "Add"))), /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "Every synced calendar appointment, gathered into one running list \u2014 the same items shown day-by-day on Glance and week-by-week on Week. Read-only here; edit or delete them in iCloud. Your own dated to-dos aren't repeated here since they already show on Glance." }, "All dated items"), upcoming.length === 0 ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13.5, color: COLORS.inkSoft } }, "No synced calendar appointments yet.") : upcoming.map((t) => /* @__PURE__ */ React.createElement("div", { key: t.id, style: { display: "flex", alignItems: "center", gap: 8, padding: "8px 0", borderBottom: `1px solid ${COLORS.line}`, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10.5, fontWeight: 700, color: COLORS.slate, border: `1px solid ${COLORS.slate}`, borderRadius: 4, padding: "1px 5px" } }, "CALENDAR"), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 120 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: COLORS.ink } }, t.text), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11.5, color: COLORS.inkSoft } }, fmtDate(t.date)))))));
  }
