(() => {
  ...
  var POOL_CATEGORIES = [
    ...
    { key: "tracker", label: "Tracker update requests", color: "gold" }
  ];
  ...
  function WeightTab({ logs, setLogs }) {
    ...
    )), fitbitError && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 10, fontSize: 13, color: COLORS.danger } }, fitbitError), fitbitResult && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 10, fontSize: 13, color: COLORS.green, fontWeight: 600 } }, "\u2713 ", fitbitResult)), /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(SectionTitle, null, "History"), [...logs].reverse().map((l) => {
