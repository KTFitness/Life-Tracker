...
Notes: ${notes || "(none)"}`;
  ...
  function BlockPicker({ value, onSelect, taskOptions, placeholder, colorHex }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { position: "relative", flex: 1 } }, /* @__PURE__ */ React.createElement(
    ...
    ), open && /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", zIndex: 6, left: 0, right: 0, border: `1px solid ${COLORS.line}`, borderRadius: 8, background: "#fff", marginTop: 2, maxHeight: 220, overflowY: "auto", boxShadow: "0 2px 8px rgba(0,0,0,0.08)" } }, taskMatches.length > 0 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: COLORS.inkSoft, fontWeight: 700, padding: "4px 10px", background: COLORS.bg } }, "From your lists"), taskMatches.slice(0, 15).map((t) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: t.id,
        onMouseDown: (e) => e.preventDefault(),
        onClick: () => {
          onSelect({ category: "other", label: t.text });
          setQuery("");
          setOpen(false);
        },
      ...
      /* @__PURE__ */ React.createElement("span", { style: { fontSize: 9.5, fontWeight: 700, color: COLORS.inkSoft, marginLeft: 8, flexShrink: 0 } }, t.sourceLabel)
  ...
  function ScheduleSection({ viewDate, timeScheduleSettings, setTimeScheduleSettings, morningTemplate, setMorningTemplate, eveningTemplate, setEveningTemplate, timeSchedules, setTimeSchedules, todos, weeklyPool, recurringTasks }) {
    ...
    const taskOptions = [
      ...(todos || []).filter((t) => t.date === viewDate && t.source !== "calendar" && t.source !== "calendar-live" && t.source !== "retreat").map((t) => ({ id: "todo-" + t.id, text: t.text, sourceLabel: "TO-DO" })),
      ...(weeklyPool || []).map((p) => ({ id: "pool-" + p.id, text: p.text, sourceLabel: "POOL" })),
      ...dueRecurringTasksForDate(viewDate, recurringTasks).map((r) => ({ id: "recur-" + r.id, text: r.text, sourceLabel: "RECURRING" }))
    ];
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "A planned-vs-actual time log for the day, so you can see where time is actually going rather than just what got ticked off." }, "Schedule"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: COLORS.inkSoft } }, "Day runs from"), /* @__PURE__ */ React.createElement(Input, { type: "time", value: timeScheduleSettings.dayStart, onChange: (e) => setTimeScheduleSettings({ ...timeScheduleSettings, dayStart: e.target.value }), style: { width: 100 } }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: COLORS.inkSoft } }, "to"), /* @__PURE__ */ React.createElement(Input, { type: "time", value: timeScheduleSettings.dayEnd, onChange: (e) => setTimeScheduleSettings({ ...timeScheduleSettings, dayEnd: e.target.value }), style: { width: 100 } }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: COLORS.inkSoft } }, "\u2014 outside this is just Sleep."))), /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(CollapseHeader, { collapsed: isCollapsed("morning"), onToggle: () => toggleSection("morning") }, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "The fixed parts of your morning \u2014 these auto-fill into Planned on any day you haven't touched yet." }, "Morning template")), !isCollapsed("morning") && renderTemplateEditor("morning", morningTemplate)), /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(CollapseHeader, { collapsed: isCollapsed("evening"), onToggle: () => toggleSection("evening") }, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "Same idea for the fixed parts of your evening." }, "Evening template")), !isCollapsed("evening") && renderTemplateEditor("evening", eveningTemplate)), /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "Planned is what you meant to do; Actual is what really happened. Matching colours means you stayed on track." }, fmtDate(viewDate)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", fontSize: 11, color: COLORS.inkSoft, fontWeight: 700, marginBottom: 6, paddingLeft: 56 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, "Planned"), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, "Actual")), slots.map((t) => {
    ...
    })), /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "Why did today go the way it did \u2014 helpful to look back on later." }, "Notes"), /* @__PURE__ */ React.createElement(
      "textarea",
      {
