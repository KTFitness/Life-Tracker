(() => {
  ...
  function generateHalfHourSlots(dayStart, dayEnd) {
    const slots = [];
    let [h, m] = (dayStart || "06:00").split(":").map(Number);
    const [endH, endM] = (dayEnd || "22:00").split(":").map(Number);
    let guard = 0;
    while ((h < endH || h === endH && m < endM) && guard < 96) {
  ...
  function calendarEventsForDate(dateStr, todos) {
    ...
    (todos || []).filter((t) => t.date === dateStr && (t.source === "calendar" || t.source === "calendar-live")).forEach((t) => {
      ...
      if (rangeMatch) {
        ...
        let [h, m] = roundDownToHalfHour(start).split(":").map(Number);
        const [endH, endM] = end.split(":").map(Number);
        let guard = 0;
        while ((h < endH || h === endH && m < endM) && guard < 48) {
          results.push({ time: `${String(h).padStart(2, "0")}:${String(m).padStart(2, "0")}`, title });
          m += 30;
          if (m >= 60) {
            m = 0;
            h++;
      ...
      if (singleMatch) results.push({ time: roundDownToHalfHour(singleMatch[1]), title: singleMatch[2] });
    });
    return results;
  }
...
Notes: ${notes || "(none)"}`;
  ...
  function ScheduleSection({ viewDate, timeScheduleSettings, setTimeScheduleSettings, morningTemplate, setMorningTemplate, eveningTemplate, setEveningTemplate, timeSchedules, setTimeSchedules, todos, weeklyPool, recurringTasks }) {
    ...
    const slots = generateHalfHourSlots(timeScheduleSettings.dayStart, timeScheduleSettings.dayEnd);
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "Planned is what you meant to do; Actual is what really happened. Matching colours means you stayed on track." }, fmtDate(viewDate)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", fontSize: 11, color: COLORS.inkSoft, fontWeight: 700, marginBottom: 6, paddingLeft: 56 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 4 } }, "Planned"), /* @__PURE__ */ React.createElement("div", { style: { flex: 6 } }, "Actual")), slots.map((t) => {
      ...
      return /* @__PURE__ */ React.createElement("div", { key: t, style: { display: "flex", alignItems: "center", gap: 6, padding: "4px 6px", borderBottom: `1px solid ${COLORS.line}`, background: rowBg, borderRadius: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11.5, color: COLORS.inkSoft, width: 48, flexShrink: 0 } }, t), /* @__PURE__ */ React.createElement("div", { style: { flex: 4, display: "flex", alignItems: "center", gap: 3, minWidth: 0 } }, /* @__PURE__ */ React.createElement(
        BlockPicker,
        {
          value: planned,
