(() => {
  ...
  function RecipeAutocomplete({ recipes, onSelectRecipe, onSelectCustom, placeholder, style }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { position: "relative", flex: 1, minWidth: 160, ...style } }, /* @__PURE__ */ React.createElement(
      ...
      "button",
      {
        ...
        style: { display: "block", width: "100%", textAlign: "left", background: "none", border: "none", padding: "8px 10px", fontSize: 13.5, cursor: "pointer", color: COLORS.ink, borderBottom: `1px solid ${COLORS.line}` }
      },
      r.name
    ))));
  }
  ...
  function MealsTab({ today, meals, setMeals, recipes, setRecipes, shoppingList, setShoppingList, nutritionTargets, setNutritionTargets }) {
    ...
    return /* @__PURE__ */ React.createElement("div", null, retreat && /* @__PURE__ */ React.createElement(Card, { style: { borderColor: COLORS.gold, background: COLORS.claySoft } }, /* @__PURE__ */ React.createElement(Pill, { tone: "clay" }, "Retreat menu \u2014 ", retreat.theme), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8, fontSize: 14, lineHeight: 1.7, color: COLORS.ink } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("b", null, "Breakfast:"), " ", RETREAT_CONSTANTS.breakfast), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("b", null, "Snack:"), " ", RETREAT_CONSTANTS.snack), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("b", null, "Lunch:"), " ", retreat.lunch), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("b", null, "Dinner:"), " ", retreat.dinner))), /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "Add as many items as you like to each slot \u2014 search your recipes by typing, or add something custom that isn't in your library." }, "Plan a day"), /* @__PURE__ */ React.createElement(Input, { type: "date", value: day, onChange: (e) => setDay(e.target.value), style: { marginBottom: 10 } }), [
      ...
      return /* @__PURE__ */ React.createElement("div", { key: slot, style: { marginBottom: 14 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11.5, color: COLORS.inkSoft, marginBottom: 3 } }, label), items.map((it) => {
        ...
        return /* @__PURE__ */ React.createElement("div", { key: it.id, style: { display: "flex", alignItems: "center", gap: 6, padding: "4px 0" } }, /* @__PURE__ */ React.createElement("span", { style: { flex: 1, fontSize: 13.5, color: COLORS.ink } }, recipe ? recipe.name : it.customText), recipe && recipe.calories != null && /* @__PURE__ */ React.createElement(Select, { value: it.servings || 1, onChange: (e) => updateSlotItemServings(slot, it.id, parseFloat(e.target.value)), style: { fontSize: 12, padding: "4px 6px" } }, SERVING_SIZE_OPTIONS.map((o) => /* @__PURE__ */ React.createElement("option", { key: o.value, value: o.value }, o.label))), recipe && recipe.calories == null && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: COLORS.inkSoft } }, "no nutrition info"), /* @__PURE__ */ React.createElement("button", { onClick: () => removeSlotItem(slot, it.id), style: { background: "none", border: "none", color: COLORS.danger, cursor: "pointer", fontSize: 12 } }, "\u2715"));
    ...
    ), bulkRecipeChoice !== "__custom__" && /* @__PURE__ */ React.createElement(Select, { value: bulkServings, onChange: (e) => setBulkServings(parseFloat(e.target.value)), style: { minWidth: 120 } }, SERVING_SIZE_OPTIONS.map((o) => /* @__PURE__ */ React.createElement("option", { key: o.value, value: o.value }, o.label)))), bulkRecipeChoice !== "__custom__" && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, color: COLORS.ink, marginBottom: 8 } }, "Selected: ", /* @__PURE__ */ React.createElement("b", null, (recipes.find((r) => r.id === bulkRecipeChoice) || {}).name), /* @__PURE__ */ React.createElement("button", { onClick: () => setBulkRecipeChoice("__custom__"), style: { marginLeft: 8, background: "none", border: "none", color: COLORS.danger, cursor: "pointer", fontSize: 12 } }, "clear")), /* @__PURE__ */ React.createElement(Input, { placeholder: "\u2026or type something custom", value: bulkRecipeChoice === "__custom__" ? bulkCustomText : "", onChange: (e) => {
      setBulkRecipeChoice("__custom__");
      setBulkCustomText(e.target.value);
    }, style: { width: "100%", marginBottom: 8 } }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center", marginBottom: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11.5, color: COLORS.inkSoft } }, "Starting"), /* @__PURE__ */ React.createElement(Input, { type: "date", value: bulkStartDate, onChange: (e) => setBulkStartDate(e.target.value) }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11.5, color: COLORS.inkSoft } }, "for"), /* @__PURE__ */ React.createElement(Input, { type: "number", min: "1", value: bulkDays, onChange: (e) => setBulkDays(e.target.value), style: { width: 60 } }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11.5, color: COLORS.inkSoft } }, "day(s)"), /* @__PURE__ */ React.createElement(Btn, { onClick: applyBulkMealFill }, "Set")), bulkMessage && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, color: COLORS.green, fontWeight: 600 } }, "\u2713 ", bulkMessage), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: COLORS.inkSoft, marginTop: 6 } }, "This overwrites that slot on the selected days if something's already there."))), /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(CollapseHeader, { collapsed: isCollapsed("recipes"), onToggle: () => toggleSection("recipes") }, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "Add manually, or paste a recipe as: name on the first line, then one ingredient per line like '2 cup flour', then instructions." }, "Recipe library")), !isCollapsed("recipes") && /* @__PURE__ */ React.createElement(React.Fragment, null, recipes.length === 0 ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13.5, color: COLORS.inkSoft, marginBottom: 10 } }, "No recipes yet.") : [...recipes].sort((a, b) => a.name.localeCompare(b.name)).map((r) => {
  ...
  function TodoTab({ todos, setTodos, weeklyPool, setWeeklyPool, todayPicks, setTodayPicks, dismissedIds, setDismissedIds, recurringTasks, setRecurringTasks, focusItems, setFocusItems, focusDone, today }) {
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "Habits you're building \u2014 shown at the top of Glance and Week, tick off each day. Tap 'history' on any item for a streak and a month-at-a-glance view." }, "Focus"), focusItems.map((f, i) => {
      ...
      )))), /* @__PURE__ */ React.createElement("div", { style: { marginLeft: 24, marginTop: 4 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => toggleStepsExpanded(f.id), style: { background: "none", border: "none", color: COLORS.green, cursor: "pointer", fontSize: 11.5, padding: "2px 0" } }, (f.steps || []).length > 0 ? `${expandedSteps[f.id] ? "\u25BE" : "\u25B8"} steps (${(f.steps || []).filter((s) => s.done).length}/${f.steps.length})` : `${expandedSteps[f.id] ? "\u25BE" : "\u25B8"} add steps`), expandedSteps[f.id] && /* @__PURE__ */ React.createElement("div", { style: { paddingLeft: 4 } }, (f.steps || []).map((s) => /* @__PURE__ */ React.createElement("div", { key: s.id, style: { display: "flex", alignItems: "center", gap: 6, padding: "3px 0" } }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: s.done, onChange: () => toggleFocusStepDone(f.id, s.id), style: { accentColor: COLORS.clay, width: 14, height: 14, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("span", { style: { flex: 1, fontSize: 13, color: s.done ? COLORS.inkSoft : COLORS.ink, textDecoration: s.done ? "line-through" : "none" } }, s.text), /* @__PURE__ */ React.createElement("button", { onClick: () => removeFocusStep(f.id, s.id), style: { background: "none", border: "none", color: COLORS.danger, cursor: "pointer", fontSize: 11 } }, "\u2715"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, marginTop: 4 } }, /* @__PURE__ */ React.createElement(
        Input,
        {
          placeholder: "Add a step",
