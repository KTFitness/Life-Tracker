...
Notes: ${notes || "(none)"}`;
  ...
  function ScheduleTab({ today, timeScheduleSettings, setTimeScheduleSettings, morningTemplate, setMorningTemplate, eveningTemplate, setEveningTemplate, timeSchedules, setTimeSchedules }) {
    const [day, setDay] = useState(today);
    const dayEntry = timeSchedules[day] || {};
    ...
    const setBlock = (which, time, patch) => {
      ...
      setTimeSchedules({ ...timeSchedules, [day]: { ...dayEntry, [key]: nextMap } });
    };
    const setNotes = (text) => setTimeSchedules({ ...timeSchedules, [day]: { ...dayEntry, notes: text } });
    const [copyMsg, setCopyMsg] = useState("");
    const copySummary = async () => {
      const text = generateScheduleSummaryText(day, plannedMap, actualMap, dayEntry.notes, slots);
      try {
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "A planned-vs-actual time log for the day, so you can see where time is actually going rather than just what got ticked off." }, "Schedule"), /* @__PURE__ */ React.createElement(Input, { type: "date", value: day, onChange: (e) => setDay(e.target.value), style: { marginBottom: 10 } }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: COLORS.inkSoft } }, "Day runs from"), /* @__PURE__ */ React.createElement(Input, { type: "time", value: timeScheduleSettings.dayStart, onChange: (e) => setTimeScheduleSettings({ ...timeScheduleSettings, dayStart: e.target.value }), style: { width: 100 } }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: COLORS.inkSoft } }, "to"), /* @__PURE__ */ React.createElement(Input, { type: "time", value: timeScheduleSettings.dayEnd, onChange: (e) => setTimeScheduleSettings({ ...timeScheduleSettings, dayEnd: e.target.value }), style: { width: 100 } }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: COLORS.inkSoft } }, "\u2014 outside this is just Sleep."))), /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(CollapseHeader, { collapsed: isCollapsed("morning"), onToggle: () => toggleSection("morning") }, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "The fixed parts of your morning \u2014 these auto-fill into Planned on any day you haven't touched yet." }, "Morning template")), !isCollapsed("morning") && renderTemplateEditor("morning", morningTemplate)), /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(CollapseHeader, { collapsed: isCollapsed("evening"), onToggle: () => toggleSection("evening") }, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "Same idea for the fixed parts of your evening." }, "Evening template")), !isCollapsed("evening") && renderTemplateEditor("evening", eveningTemplate)), /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "Planned is what you meant to do; Actual is what really happened. Matching colours means you stayed on track." }, fmtDate(day)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", fontSize: 11, color: COLORS.inkSoft, fontWeight: 700, marginBottom: 6, paddingLeft: 56 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, "Planned"), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, "Actual")), slots.map((t) => {
      ...
      return /* @__PURE__ */ React.createElement("div", { key: t, style: { display: "flex", alignItems: "center", gap: 6, padding: "4px 0", borderBottom: `1px solid ${COLORS.line}` } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11.5, color: COLORS.inkSoft, width: 48, flexShrink: 0 } }, t), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "flex", gap: 4 } }, /* @__PURE__ */ React.createElement(
        Select,
        {
          value: planned && planned.category || "",
          onChange: (e) => setBlock("planned", t, { category: e.target.value, label: "" }),
          style: { fontSize: 11.5, padding: "4px 6px", flex: 1, background: plannedCat ? plannedCat.color + "33" : "#fff", borderColor: plannedCat ? plannedCat.color : COLORS.line }
        },
        /* @__PURE__ */ React.createElement("option", { value: "" }, "\u2014"),
        TIME_BLOCK_CATEGORIES.map((c) => /* @__PURE__ */ React.createElement("option", { key: c.key, value: c.key }, c.label))
      ), planned && planned.category === "other" && /* @__PURE__ */ React.createElement(Input, { placeholder: "What?", value: planned.label || "", onChange: (e) => setBlock("planned", t, { label: e.target.value }), style: { fontSize: 11.5, padding: "4px 6px", width: 70 } })), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "flex", gap: 4 } }, /* @__PURE__ */ React.createElement(
        Select,
        {
          value: actual && actual.category || "",
          onChange: (e) => setBlock("actual", t, { category: e.target.value, label: "" }),
          style: { fontSize: 11.5, padding: "4px 6px", flex: 1, background: actualCat ? actualCat.color + "33" : "#fff", borderColor: actualCat ? actualCat.color : COLORS.line }
        },
        /* @__PURE__ */ React.createElement("option", { value: "" }, "\u2014"),
        TIME_BLOCK_CATEGORIES.map((c) => /* @__PURE__ */ React.createElement("option", { key: c.key, value: c.key }, c.label))
      ), actual && actual.category === "other" && /* @__PURE__ */ React.createElement(Input, { placeholder: "What?", value: actual.label || "", onChange: (e) => setBlock("actual", t, { label: e.target.value }), style: { fontSize: 11.5, padding: "4px 6px", width: 70 } })));
