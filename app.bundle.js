...
Notes: ${notes || "(none)"}`;
  ...
  function MealsTab({ today, meals, setMeals, recipes, setRecipes, shoppingList, setShoppingList, nutritionTargets, setNutritionTargets }) {
            ...
            items2.forEach((it) => {
              ...
              if (r && r.ingredients && r.ingredients.length > 0) {
                r.ingredients.forEach((ing) => {
                  ...
                  aggregated[key].qty += ing.qty * servings;
                });
    ...
    }), shoppingList.items.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 10 } }, /* @__PURE__ */ React.createElement(Btn, { tone: "ghost", onClick: printShoppingList }, "\u{1F5A8} Print / Save as PDF (ticked items)"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: COLORS.inkSoft, marginTop: 4 } }, "Tick whatever you actually want from this trip first \u2014 only ticked items go on the printout.")), shoppingList.unmatched && shoppingList.unmatched.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11.5, fontWeight: 700, color: COLORS.clay, marginBottom: 4 } }, "Not itemised (no recipe linked) \u2014 plan for these separately:"), shoppingList.unmatched.map((u, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { fontSize: 12, color: COLORS.inkSoft, padding: "2px 0" } }, u))))), /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(SectionTitle, null, "Logged days"), Object.keys(meals).sort().reverse().slice(0, 10).map((d) => /* @__PURE__ */ React.createElement("div", { key: d, style: { padding: "6px 0", borderBottom: `1px solid ${COLORS.line}`, fontSize: 13 } }, /* @__PURE__ */ React.createElement("div", { style: { color: COLORS.inkSoft, fontSize: 11.5 } }, fmtDate(d)), /* @__PURE__ */ React.createElement("div", null, [meals[d].breakfast, meals[d].lunch, meals[d].dinner, meals[d].snacks].filter(Boolean).join(" \xB7 "))))));
  }
