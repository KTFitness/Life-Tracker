...
Notes: ${notes || "(none)"}`;
  ...
  function BlockPicker({ value, onSelect, taskOptions, placeholder, colorHex }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { position: "relative", flex: 1 } }, /* @__PURE__ */ React.createElement(
      Input,
      {
        ...
        style: { width: "100%", fontSize: 11.5, padding: "4px 6px", background: colorHex ? colorHex + "33" : "#fff", borderColor: colorHex || COLORS.line }
      }
  ...
  function ScheduleSection({ viewDate, timeScheduleSettings, setTimeScheduleSettings, morningTemplate, setMorningTemplate, eveningTemplate, setEveningTemplate, timeSchedules, setTimeSchedules, todos, weeklyPool, recurringTasks }) {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "Planned is what you meant to do; Actual is what really happened. Matching colours means you stayed on track." }, fmtDate(viewDate)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", fontSize: 11, color: COLORS.inkSoft, fontWeight: 700, marginBottom: 6, paddingLeft: 56 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 4 } }, "Planned"), /* @__PURE__ */ React.createElement("div", { style: { flex: 6 } }, "Actual")), slots.map((t) => {
      ...
      ), planned && planned.category && /* @__PURE__ */ React.createElement("button", { onClick: () => extendBlock("planned", t), title: "Copy into the next half-hour", style: { background: "none", border: "none", color: COLORS.inkSoft, cursor: "pointer", fontSize: 13, padding: "0 2px", flexShrink: 0 } }, "\u2935")), /* @__PURE__ */ React.createElement("div", { style: { flex: 6, display: "flex", alignItems: "center", gap: 3 } }, /* @__PURE__ */ React.createElement(
        BlockPicker,
        {
          value: actual,
