...
Notes: ${notes || "(none)"}`;
  ...
  function SkinTab({ today, isRetreatDay, ziipSettings, setZiipSettings, ziipToday, ziipDayIdx, ziipDone, setZiipDone, amDone, setAmDone, pmDone, setPmDone, skinPlan, setSkinPlan, ledMaskDone, setLedMaskDone, skinPurchases, setSkinPurchases }) {
