(() => {
  ...
  function describeRecurrence(task) {
    ...
    if (task.frequency === "interval-days") return `Every ${task.intervalDays} day${task.intervalDays === 1 ? "" : "s"}, starting ${fmtDate(task.anchorDate)}`;
  ...
  function WeekTab({ today, fitnessSettings, fitnessOverrides, fitnessLogs, ziipSettings, todos, meals, weeklyPool, todayPicks, poolDone, recurringTasks, recurringDone, weeklyReflections, setWeeklyReflections, setTab, setViewDate }) {
