  ...
  function BlockPicker({ value, onSelect, taskOptions, placeholder, colorHex }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { position: "relative", flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement(
      Input,
      {
        ...
        style: { width: "100%", fontSize: 11.5, padding: "4px 6px", background: "#fff", borderColor: COLORS.line }
      }
  ...
  function ScheduleSection({ viewDate, timeScheduleSettings, setTimeScheduleSettings, morningTemplate, setMorningTemplate, eveningTemplate, setEveningTemplate, timeSchedules, setTimeSchedules, todos, weeklyPool, recurringTasks }) {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement(SectionTitle, { sub: "Planned is what you meant to do; Actual is what really happened. Matching colours means you stayed on track." }, fmtDate(viewDate)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", fontSize: 11, color: COLORS.inkSoft, fontWeight: 700, marginBottom: 6, paddingLeft: 56 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 4 } }, "Planned"), /* @__PURE__ */ React.createElement("div", { style: { flex: 6 } }, "Actual")), hourMarks.map((hourMark) => {
      ...
      return /* @__PURE__ */ React.createElement("div", { key: hourMark }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, padding: "2px 6px", marginTop: 2 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10.5, fontWeight: 700, color: COLORS.inkSoft, width: 48, flexShrink: 0 } }, hourMark), openHourControl === hourMark ? /* @__PURE__ */ React.createElement(
        ...
        return /* @__PURE__ */ React.createElement("div", { key: t, style: { display: "flex", alignItems: "center", gap: 6, padding: "4px 6px", borderBottom: `1px solid ${COLORS.line}`, background: rowBg, borderRadius: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11.5, color: COLORS.inkSoft, width: 48, flexShrink: 0 } }, split === 1 ? "" : t), /* @__PURE__ */ React.createElement("div", { style: { flex: 4, display: "flex", alignItems: "center", gap: 3, minWidth: 0 } }, /* @__PURE__ */ React.createElement(
          BlockPicker,
          {
            value: planned,
        ...
        ), planned && planned.category && /* @__PURE__ */ React.createElement("button", { onClick: () => extendBlock("planned", t), title: "Copy into the next slot", style: { background: COLORS.line, border: "none", borderRadius: 4, color: COLORS.ink, cursor: "pointer", fontSize: 12, fontWeight: 700, padding: "3px 5px", flexShrink: 0, lineHeight: 1 } }, "\u2193")), /* @__PURE__ */ React.createElement("div", { style: { flex: 6, display: "flex", alignItems: "center", gap: 3, minWidth: 0 } }, /* @__PURE__ */ React.createElement(
          BlockPicker,
          {
            value: actual,
        ...
        ), actual && actual.category && /* @__PURE__ */ React.createElement("button", { onClick: () => extendBlock("actual", t), title: "Copy into the next slot", style: { background: COLORS.line, border: "none", borderRadius: 4, color: COLORS.ink, cursor: "pointer", fontSize: 12, fontWeight: 700, padding: "3px 5px", flexShrink: 0, lineHeight: 1 } }, "\u2193"), /* @__PURE__ */ React.createElement("button", { onClick: () => markActualAsPlanned(t), disabled: !planned, title: "Did as planned", style: { background: "none", border: "none", color: planned ? COLORS.green : COLORS.line, cursor: planned ? "pointer" : "default", fontSize: 15, padding: "0 2px", flexShrink: 0 } }, "\u2713"), /* @__PURE__ */ React.createElement("button", { onClick: () => clearActual(t), title: "Didn't do this \u2014 clear it", style: { background: "none", border: "none", color: COLORS.danger, cursor: "pointer", fontSize: 13, padding: "0 2px", flexShrink: 0 } }, "\u2715")));
      }));
